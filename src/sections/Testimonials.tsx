  ...
  const featuredReviews = [
    {
      ...
      time: '4 months ago',
      rating: 5,
      text: "Dr Rahul is an amazing dentist. He is very patient and takes time to explain the procedure. Dr Rahul is an expert in invisalign. The clinic is also great for kids. My 5 yr old son was very comfortable getting his tooth cleaned.",
    ...
    },
    {
      ...
      time: '4 months ago',
      rating: 5,
      text: "Highly recommend Dr. Rahul. I always had dental anxiety which completely changed after I met Dr. Rahul. Had an awesome invisalign journey with my 10 year old. Excellent and prompt communication via tele health and email.",
      tags: ['invisalign', 'experienced doctor'],
    },
    {
      name: 'Rajiv Damodaran',
      reviews: 2,
      time: '4 months ago',
      rating: 5,
      text: "Highly recommend Dr Rahul's clinic. Dr Rahul is a very experienced dentist. He resolved issues other dentists was not able to treat. He is very friendly and available for patients. One of the rare doctors who truly cares!!",

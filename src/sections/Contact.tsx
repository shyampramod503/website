...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      content: 'contact@drrahuldental.com',
      link: 'mailto:contact@drrahuldental.com',
    },
    {
      icon: MapPin,
      title: 'Address',
      content: '123 Main Road, Near Metro Station, City Center, State 682020',
      link: '#',
    },
    {
      icon: Clock,
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div ref={infoRef} className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#0A2540] to-[#00A3E0] rounded-xl p-6 text-white text-center">
              ...
              <a href="tel:+919876543210" className="inline-flex items-center gap-2 bg-white text-[#0A2540] px-6 py-3 rounded-full font-semibold hover:bg-[#00E5FF] transition-colors">
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-gray-600">
              Thank you for booking with Dr. Rahul's Dental Clinic. Our team will contact you shortly to confirm your appointment.
            </DialogDescription>
          </DialogHeader>

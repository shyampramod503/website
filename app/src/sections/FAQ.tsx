...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Is your lead dentist an experienced Invisalign provider?',
      answer: 'Yes, our lead dentist is a certified Invisalign provider with extensive experience in clear aligner therapy. The team has treated hundreds of patients with Invisalign, including children and adults. Patients consistently praise the clinic for thoughtful clear aligner care.',
    },
    {
